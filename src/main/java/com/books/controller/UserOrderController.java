...
public class UserOrderController {
	...
	@GetMapping("/myOrderList")//Ï£ºÎ¨∏Î™©Î°ù+?éò?ù¥Ïß?
	...
	@GetMapping("/orderPayment")//?öå?õêÏ£ºÎ¨∏?èº
	public void insertorder() {
		log.info("?öå?õêÏ£ºÎ¨∏?éò?ù¥Ïß?");
	}
	/*
	@PostMapping("/orderPayment")//?öå?õêÏ£ºÎ¨∏
	...
	*/
	@PostMapping("/orderPayment")//?öå?õêÏ£ºÎ¨∏-ÎØ∏ÏôÑ
	...
	@GetMapping({"/myOrderDetail","/myOrderMod"})//Ï£ºÎ¨∏?ÉÅ?Ñ∏Ï°∞Ìöå(?àò?†π?ûê?†ïÎ≥?,Ï±ÖÎ™©Î°?,Ï±ÖÏ†úÎ™?)+?éò?ù¥Ïß?Î≤àÌò∏?ú†Ïß?
	...
	@PostMapping("/myOrderMod")//Ï£ºÎ¨∏?àò?†ï+?éò?ù¥Ïß?
